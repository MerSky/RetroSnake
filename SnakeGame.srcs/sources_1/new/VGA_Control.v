...
(
	...
	output reg hsync,//即为clk
	output reg vsync,//即为data
	output reg [11:0] color_out//输出给VGA的RGB数据流
);
	...
	localparam HEAD_COLOR = 12'b000011110000;//对蛇头色块进行RGB赋值（绿色）
	localparam BODY_COLOR = 12'b000011111111;//对蛇身色块进行RGB赋值（蓝绿色）
	...
	always@(posedge clk or negedge rst) begin
		if(rst) begin
			...
			if(x_pos >= 0 && x_pos < 640 && y_pos >= 0 && y_pos < 480) begin
				...
				if(x_pos[9:4] == apple_x && y_pos[9:4] == apple_y)//扫描到的点是否为苹果
					case({loy,lox})
						8'b00000000:color_out = 12'b000000000000;
						default:color_out = 12'b000000001111;//苹果颜色为蓝色
					endcase						
				else if(snake == NONE)
